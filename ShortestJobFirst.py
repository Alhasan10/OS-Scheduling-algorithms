...
# Function to sort ready queue by burst time
def sort_ready_queue_by_burst_time(queue):
...
for time in range(201):
    ...
    for returned_process in wait_temp:
        ...
        if returned_process['t_wait'] == returned_process['comes_back_after']:
            ...
            sort_ready_queue_by_burst_time(ready_queue)  # Sort the ready queue by burst time

    # Sort the ready queue by burst time
    sort_ready_queue_by_burst_time(ready_queue)
