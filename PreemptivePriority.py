# Define each process in its own dictionary
process_P1 = {'name': 'P1', 'arrival_time': 0, 'burst_time': 10, 'comes_back_after': 2, 'priority': 3, 'running_time': 0, 't_wait': 0, 'decremented': 0, 'remaining_time': 10, 'finish_time': 0, 'total_waiting': 0}
process_P2 = {'name': 'P2', 'arrival_time': 1, 'burst_time': 8, 'comes_back_after': 4, 'priority': 2, 'running_time': 0, 't_wait': 0, 'decremented': 0, 'remaining_time': 8, 'finish_time': 0, 'total_waiting': 0}
process_P3 = {'name': 'P3', 'arrival_time': 3, 'burst_time': 14, 'comes_back_after': 6, 'priority': 3, 'running_time': 0, 't_wait': 0, 'decremented': 0, 'remaining_time': 14, 'finish_time': 0, 'total_waiting': 0}
process_P4 = {'name': 'P4', 'arrival_time': 4, 'burst_time': 7, 'comes_back_after': 8, 'priority': 1, 'running_time': 0, 't_wait': 0, 'decremented': 0, 'remaining_time': 7, 'finish_time': 0, 'total_waiting': 0}
process_P5 = {'name': 'P5', 'arrival_time': 6, 'burst_time': 5, 'comes_back_after': 3, 'priority': 0, 'running_time': 0, 't_wait': 0, 'decremented': 0, 'remaining_time': 5, 'finish_time': 0, 'total_waiting': 0}
process_P6 = {'name': 'P6', 'arrival_time': 7, 'burst_time': 4, 'comes_back_after': 6, 'priority': 1, 'running_time': 0, 't_wait': 0, 'decremented': 0, 'remaining_time': 4, 'finish_time': 0, 'total_waiting': 0}
process_P7 = {'name': 'P7', 'arrival_time': 8, 'burst_time': 6, 'comes_back_after': 9, 'priority': 2, 'running_time': 0, 't_wait': 0, 'decremented': 0, 'remaining_time': 6, 'finish_time': 0, 'total_waiting': 0}
...
for time in range(201):
    ...
    if min_queue:
        if cpu:
            if min_queue['priority'] + min_queue['decremented'] < cpu['priority'] + cpu['decremented']:
                completion_time = time
                cpu['finish_time'] = completion_time  # Update finish time
...
# Display the last execution time of each process
print("\nLast Execution Time:")
for process in processes:
    if process['finish_time'] == 0 and process['remaining_time'] == 0:
        process['finish_time'] = time  # If the process has never been executed, set finish time to the current time
    print(f"{process['name']}: {process['finish_time']}")
